...
import {
    ADD_PLACE,FETCH_PLACE_SUCCESS, FETCH_PLACE_FAILED
...
function* HandleAddPlace(action) {
    ...
    const results = yield call(ExecuteSQL, "INSERT INTO Place VALUES (? , ?, ?, ?, ?)",
     [ null ,dataPlace.itemCustom.id, dataPlace.notePlace,dataPlace.statePlace, dataPlace.timePlace]);
